...
const MESSAGES = {
  en: {
    ...
    'task.destination_missing.one': 'A destination is not connected',
    ...
    'settings.label.check_updates_on_start': 'Check for updates',
  ...
  fr: {
    ...
    'task.destination_missing.one': 'Une destination n’est pas connectée',
    'task.destination_missing.other': '{n} destinations ne sont pas connectées',
    ...
    'settings.label.version': 'Version',
    'settings.label.check_updates_on_start': 'Vérifier les mises à jour',
