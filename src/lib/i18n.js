...
const MESSAGES = {
  en: {
    ...
    'form.hint.destinations': 'Each destination receives its own full copy',
    ...
    'form.hint.sources': 'Each source is copied into a folder of its own at the destination',
    'form.hint.source_single': 'Synced straight into the destination; add a second source and each gets a folder of its own',
  ...
  fr: {
    ...
    'form.hint.destinations': 'Chaque destination reçoit sa propre copie complète',
    ...
    'form.hint.source_single': 'Synchronisée directement dans la destination ; avec une deuxième source, chacune a son propre dossier',
